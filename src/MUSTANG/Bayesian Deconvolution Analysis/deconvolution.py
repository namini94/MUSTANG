...
"""
Bayesian Deconvolution Analysis for MUSTANG.

Acknowledgements:
Poisson discrete deconvolution model based on BayesTME deconvolution model. 
https://github.com/tansey-lab/bayestme/blob/main/src/bayestme/mcmc/deconvolution.py
"""
