...
class GraphFusedBinomialTree:
    def __init__(self, n_classes, edges, trend_order=0, lam2=1e-5, pg_seed=42, stability=1e-6, similarity_graph,
        ...
        ###### NN:
        self.D = utils.construct_edge_adjacency(neighbors=similarity_graph)
        #####
